...
/**
 * PettyExpenseSearch represents the model behind the search form of `common\modules\accounting\models\PettyExpense`.
 */
class PettyExpenseSearch extends PettyExpense
{
    public $seasonName;
    public $amountType;
    public $datetime;
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['pcv_no', 'seasonName','particulars', 'amountType', 'datetime', 'charge_to'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'concat(accounting_branch.name," - ",accounting_program.name," - SEASON ",accounting_season.name)', $this->seasonName])
            ->andFilterWhere(['like', 'pcv_no', $this->pcv_no])
