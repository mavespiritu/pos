...
class Student extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['season_id', 'field_id', 'page_id'], 'required', 'on' => 'searchStudent'],
            [['season_id', 'page_id'], 'required', 'on' => 'searchPayment'],
            ...
            [['prc'], 'string', 'max' => 30],
            [['id_number'], 'unique', 'message' => 'The student id number has already been taken.'],
