...
<span class="pull-right">
	<?= Html::a('<i class="fa fa-file-pdf-o"></i>&nbsp;Generate Report', ['/accounting/report/extract-expense-generation', 'id' => $id, 'season' => $season, 'branchProgram' => $branchProgram],['class' => 'btn btn-primary']) ?>
</span>
