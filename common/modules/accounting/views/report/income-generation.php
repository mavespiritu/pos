...
$this->title = 'Daily Income Report';
...
<div class="audit-index">
    ...
    <?php Panel::begin(['header' => 'Income Generation']); ?>
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= Html::button('Show Record',['class' => 'btn btn-primary btn-block', 'id' => 'audit-button', 'onclick' => '
                        (function(){ 
                            ...
                            {
                                $.ajax({
                                    url: "'.Url::to(['/accounting/report/generate-income-generation']).'?id=" + datefield + "&branchProgram=" + branchProgram + "&season=" + season,
                                    success: function (data) { 
                                        $("#income-information").empty();
                                        $("#income-information").hide();
                                        $("#income-information").fadeIn();
                                        $("#income-information").html(data);
                                    }
                                });  
                            }else{
                ...
                <div class="col-md-6">
                    <?= Html::a('Clear',['/accounting/report/income-generation'],['class' => 'btn btn-default btn-block']) ?>
                </div>
            </div>
