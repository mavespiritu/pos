...
/* @var $searchModel common\modules\accounting\models\FreebieAndIconSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Freebies and Icons';
...
?>
<div class="freebie-and-icon-index">
        ...
        <?php } ?>
            ...
            <div>
                ...
                <span class="pull-right">
                    <?= Html::button('Generate Report',['class' => 'btn btn-success', 'id' => 'freebie-icon-button']) ?>
                </span>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model){
                                ...
                                if(Yii::$app->user->can('deleteFreebieAndIcon'))
                                {
                                    $content.= Html::a('<i class="glyphicon glyphicon-trash"></i>',['/accounting/freebie-and-icon/delete', 'id' => $model->id],['data' => ['method' => 'post','confirm' => 'Are you sure you want to delete this item?']]);
                                }
                        ...
                        [
                            'attribute' => 'amount',
                            'footer' => FreebieAndIcon::getTotal($dataProvider->models, 'amount'),       
                        ],
                        'amountType',
                        'transactionNumber',
                        'datetime',
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model) use ($dateRestriction){
                                ...
                                if(Yii::$app->user->can('updateFreebieAndIcon'))
                                {
                                    if(date("Y-m-d", strtotime($model->datetime)) == date("Y-m-d"))
                                    {
                                        $content.= Html::a('<i class="glyphicon glyphicon-pencil"></i>',['/accounting/freebie-and-icon/update', 'id' => $model->id],['data' => ['method' => 'post']]);
                                    }else{
                                        if($dateRestriction){
...
<?php
    $script = '
        $( document ).ready(function() {
            $("#freebie-icon-button").click(function(){
                var url = "'.Url::to(['/accounting/freebie-and-icon/search']).'";
