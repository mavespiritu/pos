...
<h5 class="text-center">Toprank Integrated Systems<br>
						Accounting<br>
						Freebies and Icons Income Report</h5>
		...
		<?php if(!empty($data)){ ?>
			...
			<?php foreach($data as $datum){ ?>
				<tr>
					...
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['last_name'].' '.$datum['extension_name'].', '.$datum['first_name'].' '.$datum['middle_name'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['pr'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['ar_no'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['codeName'] ?></td>
