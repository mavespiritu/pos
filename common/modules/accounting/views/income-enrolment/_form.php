...
<div class="income-enrolment-form">
    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            ...
            <?= $form->field($model, 'or_no')->textInput(['maxlength' => true, 'disabled' => 'disabled']) ?>
    ...
    if(Yii::$app->controller->action->id != 'update'){
        $script = '
            $( document ).ready(function() {
                ...
                $("#incomeenrolment-season_id").on("change", function(){ 
                    $.ajax({
                        url: "'.Url::to(['/accounting/student/take-or']).'?id=" + $("#incomeenrolment-season_id").val(),
