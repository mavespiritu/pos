		...
		<?php if(!empty($data)){ ?>
			...
			<?php foreach($data as $datum){ ?>
				<tr>
					...
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['subject'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['no_of_pages'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= $datum['no_of_pieces'] ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= number_format($datum['amount_per_page'], 2) ?></td>
					<td style="text-align:center; width: <?= $width ?>%"><?= number_format($datum['total_amount'], 2) ?></td>
				...
				<?php $i++; ?>
				<?php $totalAmount+=$datum['total_amount']; ?>
			<?php } ?>
		<?php }  ?>
		<tr>
