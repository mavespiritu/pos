...
/* @var $searchModel common\modules\accounting\models\OtherExpenseSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Other Expenses';
        ...
        <?php } ?>
            ...
            <div>
                ...
                <span class="pull-right">
                    <?= Html::button('Generate Report',['class' => 'btn btn-success', 'id' => 'other-expense-button']) ?>
                </span>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model){
                                ...
                                if(Yii::$app->user->can('deleteOtherExpense'))
                                {
                                    $content.= Html::a('<i class="glyphicon glyphicon-trash"></i>',['/accounting/other-expense/delete', 'id' => $model->id],['data' => ['method' => 'post','confirm' => 'Are you sure you want to delete this item?']]);
                                }
                        ...
                        [
                            'attribute' => 'amount',
                            'footer' => OtherExpense::getTotal($dataProvider->models, 'amount'),       
                        ],
                        'charge_to',
                        'amountType',
                        'datetime',
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model) use ($dateRestriction){
                                ...
                                if(Yii::$app->user->can('updateOtherExpense'))
                                {
                                    if(date("Y-m-d", strtotime($model->datetime)) == date("Y-m-d"))
                                    {
                                        $content.= Html::a('<i class="glyphicon glyphicon-pencil"></i>',['/accounting/other-expense/update', 'id' => $model->id],['data' => ['method' => 'post']]);
                                    }else{
                                        if($dateRestriction){
...
<?php
    $script = '
        $( document ).ready(function() {
            $("#other-expense-button").click(function(){
                var url = "'.Url::to(['/accounting/other-expense/search']).'";
