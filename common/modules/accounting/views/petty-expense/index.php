...
/* @var $searchModel common\modules\accounting\models\PettyExpenseSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Petty Expenses';
        ...
        <?php } ?>
            ...
            <div>
                ...
                <span class="pull-right">
                    <?= Html::button('Generate Report',['class' => 'btn btn-success', 'id' => 'petty-expense-button']) ?>
                </span>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model){
                                ...
                                if(Yii::$app->user->can('deletePettyExpense'))
                                {
                                    $content.= Html::a('<i class="glyphicon glyphicon-trash"></i>',['/accounting/petty-expense/delete', 'id' => $model->id],['data' => ['method' => 'post','confirm' => 'Are you sure you want to delete this item?']]);
                                }
                        ...
                        [
                            'attribute' => 'food',
                            'footer' => PettyExpense::getTotal($dataProvider->models, 'food'),       
                        ],
                        [
                            'attribute' => 'supplies',
                            'footer' => PettyExpense::getTotal($dataProvider->models, 'supplies'),       
                        ],
                        [
                            'attribute' => 'load',
                            'footer' => PettyExpense::getTotal($dataProvider->models, 'load'),       
                        ],
                        [
                            'attribute' => 'fare',
                            'footer' => PettyExpense::getTotal($dataProvider->models, 'fare'),       
                        ],
                        'charge_to',
                        'datetime',
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model) use ($dateRestriction){
                                ...
                                if(Yii::$app->user->can('updatePettyExpense'))
                                {
                                    if(date("Y-m-d", strtotime($model->datetime)) == date("Y-m-d"))
                                    {
                                        $content.= Html::a('<i class="glyphicon glyphicon-pencil"></i>',['/accounting/petty-expense/update', 'id' => $model->id],['data' => ['method' => 'post']]);
                                    }else{
                                        if($dateRestriction){
...
<?php
    $script = '
        $( document ).ready(function() {
            $("#petty-expense-button").click(function(){
                var url = "'.Url::to(['/accounting/petty-expense/search']).'";
