    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= Html::button('Show Record',['class' => 'btn btn-primary btn-block', 'id' => 'audit-button', 'onclick' => '
                        (function(){ 
                            ...
                            {
                                $.ajax({
                                    url: "'.Url::to(['/accounting/audit/generate-summary']).'?id=" + datefield + "&branchProgram=" + branchProgram + "&season=" + season,
                ...
                <div class="col-md-6">
                    <?= Html::a('Clear',['/accounting/audit/cut-off-summary/'],['class' => 'btn btn-default btn-block']) ?>
                </div>
            </div>
