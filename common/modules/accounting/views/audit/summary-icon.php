...
$this->title = 'Cut-Off Summary: Icon';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="audit-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php Panel::begin(['header' => 'Cut-Off Summary']); ?>
    <div class="row">
        <div class="col-md-3">
                ...
                <div class="col-md-6">
                    <?= Html::button('Show Record',['class' => 'btn btn-primary btn-block', 'id' => 'audit-button', 'onclick' => '
                        (function(){ 
                            ...
                            {
                                $.ajax({
                                    url: "'.Url::to(['/accounting/audit/generate-summary-icon']).'?id=" + datefield + "&branchProgram=" + branchProgram + "&season=" + season,
                                ...
                                alert("Date and Branch Program must not be empty");
                            }
                        })();
                    ']) ?>
                </div>
                <div class="col-md-6">
                    <?= Html::a('Clear',['/accounting/audit/cut-off-summary-icon/'],['class' => 'btn btn-default btn-block']) ?>
                </div>
            </div>
