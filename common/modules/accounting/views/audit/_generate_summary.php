...
<span class="pull-right">
	<?php if($branchProgramName == 'All Branch Programs'){ ?>
		<?= Html::a('<i class="fa fa-file-pdf-o"></i>&nbsp;Generate Report', ['/accounting/audit/generate', 'id' => $id],['class' => 'btn btn-primary']) ?>
	<?php }else{ ?>
		<?= $seasonName == '' ? Html::a('<i class="fa fa-file-pdf-o"></i>&nbsp;Generate Report', ['/accounting/audit/generate', 'id' => $id, 'branch_program_id' => $branchProgram->id],['class' => 'btn btn-primary']) : Html::a('<i class="fa fa-file-pdf-o"></i>&nbsp;Generate Report', ['/accounting/audit/generate', 'id' => $id, 'branch_program_id' => $branchProgram->id, 'season' => $season->id],['class' => 'btn btn-primary']) ?>
	<?php } ?>
</span>
<br>
<br>
...
<h4 class="text-center">Cut-Off Summary Report<!-- : Program --></h4>
...
<div style="overflow: auto;">
	<table class="table table-bordered table-condensed table-striped table-hovered table-responsive">
		...
		<tbody>
			...
			<tr>
				...
				<td>BP and Others</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['incomes']['budgetProposals']['Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['incomes']['budgetProposals']['Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $totals['incomes'][$date]+=$data['incomes']['budgetProposals']['Cash'][$date]['total']; ?>
						<?php $budgetProposalTotal+=$data['incomes']['budgetProposals']['Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($budgetProposalTotal, 2).'</b>' ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td>&nbsp;</td>
				<td align=right>Branch Transfers</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['expenses']['branchTransfers']['Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['expenses']['branchTransfers']['Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $totals['expenses'][$date]+=$data['expenses']['branchTransfers']['Cash'][$date]['total']; ?>
						<?php $branchTransferTotal+=$data['expenses']['branchTransfers']['Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($branchTransferTotal, 2).'</b>' ?></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>OTHER</td>
			...
			<tr>
				<td colspan=2>BANK DEPOSITS</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['expenses']['bankDeposits']['Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['expenses']['bankDeposits']['Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $bankDepositTotal+=$data['expenses']['bankDeposits']['Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($bankDepositTotal, 2).'</b>' ?></td>
			</tr>
			<tr>
	...
	<table class="table table-bordered table-condensed table-striped table-hovered table-responsive" style="width: 100%;">
		<tbody>
			<tr>
				<td><b>Beginning Cash On Hand</b></td>
				<td align=right><?= $beginningcohAmount >= 0 ? number_format($beginningcohAmount, 2) : '<font color=red>'.number_format($beginningcohAmount, 2).'</font>' ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align=right><?= $bankDepositTotal >= 0 ? number_format($bankDepositTotal, 2) : '<font color=red>'.number_format($bankDepositTotal, 2).'</font>' ?></td>
			</tr>
			<tr>
				<td><b>Ending Cash On Hand</b></td>
				<td align=right><?= (($beginningcohAmount + $incomeTotal) - ($expenseTotal + $bankDepositTotal)) >= 0 ? number_format((($beginningcohAmount + $incomeTotal) - ($expenseTotal + $bankDepositTotal)), 2) : '<font color=red>'.number_format((($beginningcohAmount + $incomeTotal) - ($expenseTotal + $bankDepositTotal)), 2).'</font>' ?></td>
			</tr>
		</tbody>
	</table>
</div>
...
<div style="overflow: auto;">
	<table class="table table-bordered table-condensed table-striped table-hovered table-responsive">
		...
		<tbody>
			...
			<tr>
				...
				<td>BP and Others</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['incomes']['budgetProposals']['Non-Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['incomes']['budgetProposals']['Non-Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $totals2['incomes'][$date]+=$data['incomes']['budgetProposals']['Non-Cash'][$date]['total']; ?>
						<?php $budgetProposalTotal2+=$data['incomes']['budgetProposals']['Non-Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($budgetProposalTotal2, 2).'</b>' ?></td>
			</tr>
			<tr>
				<td colspan=2><b>TOTAL INCOME</b></td>
				<?php foreach($dates as $date){ ?>
			...
			<tr>
				...
				<td align=right>Branch Transfers</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['expenses']['branchTransfers']['Non-Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['expenses']['branchTransfers']['Non-Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $totals2['expenses'][$date]+=$data['expenses']['branchTransfers']['Non-Cash'][$date]['total']; ?>
						<?php $branchTransferTotal2+=$data['expenses']['branchTransfers']['Non-Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($branchTransferTotal2, 2).'</b>' ?></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>OTHER</td>
			...
			<tr>
				<td colspan=2>BANK DEPOSITS</td>
				<?php foreach($dates as $date){ ?>
					<?php if(isset($data['expenses']['bankDeposits']['Non-Cash'][$date])){ ?>
						<td><?= '<b>'.number_format($data['expenses']['bankDeposits']['Non-Cash'][$date]['total'], 2).'</b>' ?></td>
						<?php $bankDepositTotal2+=$data['expenses']['bankDeposits']['Non-Cash'][$date]['total']; ?>
					<?php }else{ ?>
						<td><?= number_format(0, 2) ?></td>
					<?php } ?>
				<?php } ?>
				<td align=right><?= '<b>'.number_format($bankDepositTotal2, 2).'</b>' ?></td>
			</tr>
			<tr>
				<td colspan=2><b>TOTAL EXPENSES</b></td>
				<?php foreach($dates as $date){ ?>
	...
	<table class="table table-bordered table-condensed table-striped table-hovered table-responsive" style="width: 100%;">
		<tbody>
			<tr>
				<td><b>Beginning Cash On Bank</b></td>
				<td align=right><?= $beginningcobAmount >= 0 ? number_format($beginningcobAmount, 2) : '<font color=red>'.number_format($beginningcobAmount, 2).'</font>' ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Bank Deposits</b></td>
				<td align=right><?= $bankDepositTotal2 >= 0 ? number_format($bankDepositTotal2, 2) : '<font color=red>'.number_format($bankDepositTotal2, 2).'</font>' ?></td>
			</tr>
			<tr>
				<td><b>Ending Cash On Bank</b></td>
				<td align=right><?= (($beginningcobAmount + $incomeTotal2) - ($expenseTotal2 + $bankDepositTotal2)) >= 0 ? number_format((($beginningcobAmount + $incomeTotal2 + $bankDepositTotal2) - $expenseTotal2), 2) : '<font color=red>'.number_format((($beginningcobAmount + $incomeTotal2) - ($expenseTotal2 + $bankDepositTotal2)), 2).'</font>' ?></td>
			</tr>
		</tbody>
	</table>
</div>
	...
	<div class="col-md-12">
		<table class="table table-bordered table-condensed table-striped table-hovered table-responsive">
			<tbody>
				...
				<tr>
					<td><b>Bank Deposits</b></td>
					<td align=right><?= ($bankDepositTotal + $bankDepositTotal2) >= 0 ? number_format($bankDepositTotal + $bankDepositTotal2, 2) : '<font color=red>'.number_format($bankDepositTotal + $bankDepositTotal2, 2).'</font>' ?></td>
				</tr>
				<tr>
					<td><b>Net Income</b></td>
					<td align=right><?= ($incomeTotal + $incomeTotal2) - ($expenseTotal + $expenseTotal2 + $bankDepositTotal + $bankDepositTotal2) >= 0 ? number_format(($incomeTotal + $incomeTotal2) - ($expenseTotal + $expenseTotal2 + $bankDepositTotal + $bankDepositTotal2), 2) : '<font color=red>'.number_format(($incomeTotal + $incomeTotal2) - ($expenseTotal + $expenseTotal2 + $bankDepositTotal + $bankDepositTotal2), 2).'</font>' ?></td>
				</tr>
			</tbody>
		</table>
	</div>
