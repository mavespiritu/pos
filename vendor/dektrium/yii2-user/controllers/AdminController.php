...
use dektrium\user\models\Branch;
...
class AdminController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $params['UserSearch']['BRANCH_C'] = isset($params['UserSearch']['BRANCH_C']) ? $params['UserSearch']['BRANCH_C'] : null;
        $params['UserSearch']['SCHOOL_C'] = isset($params['UserSearch']['SCHOOL_C']) ? $params['UserSearch']['SCHOOL_C'] : null;

        $additionalParams = [];

        $dataProvider = $searchModel->search($params, $additionalParams);

        $branches = Branch::find()->asArray()->orderBy(['name' => SORT_ASC])->all();
        $schools = School::find()->select(['id, concat(name," (", location," )") as name'])->asArray()->orderBy(['name' => SORT_ASC])->all();
    ...
    public function actionCreate()
    {
        ...
        $schools = School::find()->select(['id, concat(name," (", location," )") as name'])->asArray()->all();
